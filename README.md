This repository contains my front-end and back-end projects built following the [roadmap.sh](https://roadmap.sh/) front-end and back-end developer path.
...
(Task2 - github user activity, i.e github event)[https://roadmap.sh/projects/github-user-activity]
